  ...
  return (
    <div className="shadow-lg w-full mb-6 mt-4 ">
      ...
      <div className="flex ml-0 mb-10 bg-[#513BD7] p-2 h-[62px]">
        ...
        <button onClick={() =>setShowJob(true)} className="relative group ml-10  px-3 py-2 text-sm tracking-widest bg-white hover:bg-sky-400 hover:text-white rounded-lg">
          Position
        </button>
        ...
        <button className="ml-10  px-3 py-2 text-sm tracking-widest bg-white hover:bg-green-400 hover:text-white rounded-lg">Accept</button>
        <button className="ml-10  px-3 py-2 text-sm tracking-widest bg-white hover:bg-red-400 hover:text-white rounded-lg">Reject</button>
      </div>
      <h1 className="font-bold">Queuing List</h1>
