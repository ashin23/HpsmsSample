    ...
    <div className="grid flex-col shadow-lg w-full mb-6 mt-4 ">
      <div className="w-[99.1%]">
        <div className="flex ml-0 mb-10  bg-[#513BD7]  p-2 h-[62px]">
          ...
          <button className="ml-10  px-3 py-2 text-sm tracking-widest bg-white hover:bg-green-400 hover:text-white rounded-lg">
            Accept
          </button>
          <button className="ml-10  px-3 py-2 text-sm tracking-widest bg-white hover:bg-red-400 hover:text-white rounded-lg">
            Reject
          </button>
        </div>
        <h1 className="font-bold">Applicants List</h1>
          ...
          <table className="w-full bg-[#FBF8FF]">
            <thead>
              <tr className="border border-solid border-l-0  justify-evenly">
                ...
                <td className="text-md px-6 py-3">Requirements</td>
              </tr>
            </thead>
            <tr>
              <td>
                <input type="checkbox" className="mr-1"></input>janjay
              </td>
            ...
            <tr>
              <td>
                <input type="checkbox" className="mr-1"></input>beatriz
              </td>
              <td>Waiter</td>
              <td>example123@gmail.com</td>
              <td>Complete</td>
            ...
            <tr>
              <td>
                <input type="checkbox" className="mr-1"></input>janearl
              </td>
              <td>Dishwasher</td>
              <td>example123@gmail.com</td>
              <td>Complete</td>
            ...
            <tr>
              <td>
                <input type="checkbox" className="mr-1"></input>Hera
              </td>
              <td>Laundry</td>
              <td>example123@gmail.com</td>
              <td>Complete</td>
            ...
            <tr>
              <td>
                <input type="checkbox" className="mr-1"></input>Sean
              </td>
              <td>Room Attendant</td>
              <td>example123@gmail.com</td>
              <td>Complete</td>
